      ...
      {stopAnimation && (
        <div className="animation_slideInto flex justify-center items-start">
          <img
            ...
            className={`${windowSize < 800 ? `${styles.posua_logo_mobile} top-[5%] ` : `${styles.posua_logo} top-[2%]`} absolute flex justify-center items-start object-contain overflow-hidden h-[40vh] w-[100vw] z-[49000] left-5 `}
            alt=""
          />
          <div
